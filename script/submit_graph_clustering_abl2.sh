#!/bin/bash
#SBATCH --job-name=gca2
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/gca2.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/graph_clustering_abl2.sh "async"