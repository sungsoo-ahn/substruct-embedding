#!/bin/bash
#SBATCH --job-name=ot_contrast
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/ot_contrast.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/ot_contrast.sh "async" $SINKHORN_ITERS