#!/bin/bash
#SBATCH --job-name=graphlog0
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/graphlog0.log
#SBATCH --mem=50G
#SBATCH -N 1
#SBATCH -G 1
