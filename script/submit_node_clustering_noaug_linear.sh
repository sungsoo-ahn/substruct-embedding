#!/bin/bash
#SBATCH --job-name=ncnl
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/ncnl.log
#SBATCH --mem=50G
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/zinc/node_clustering_noaug_linear.sh