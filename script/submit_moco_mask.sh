#!/bin/bash
#SBATCH --job-name=moco_mask
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=48:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/moco_mask.log
#SBATCH -N 1
#SBATCH -G 1
