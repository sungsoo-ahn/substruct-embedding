#!/bin/bash
#SBATCH --job-name=rgroupdata
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/rgroupdata.log
#SBATCH -N 1
#SBATCH -G 1
