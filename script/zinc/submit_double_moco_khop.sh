#!/bin/bash
#SBATCH --job-name=double_moco_khop
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=48:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/double_moco_khop.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/zinc/double_moco_khop.sh