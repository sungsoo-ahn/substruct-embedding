#!/bin/bash
#SBATCH --job-name=emnp04
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/submit_emnp04.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/edge_mask_node_pred.sh "async" 0.4