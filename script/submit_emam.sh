#!/bin/bash
#SBATCH --job-name=emam
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/submit_emam.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/edge_mask_attr_mask.sh "async" $EDGE_MASK_RATIO