#!/bin/bash
#SBATCH --job-name=str_contra
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/str_contra.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/struct_contrastive.sh "async" $AUG_RATE