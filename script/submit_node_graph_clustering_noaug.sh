#!/bin/bash
#SBATCH --job-name=ngcn
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/ngcn.log
#SBATCH --mem=50G
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/zinc/node_graph_clustering_noaug.sh