#!/bin/bash
#SBATCH --job-name=wlr20
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/submit3.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/subgraph_node_mask.sh "offline" 2.0