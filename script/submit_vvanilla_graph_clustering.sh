#!/bin/bash
#SBATCH --job-name=vvgc
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/vvgc.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/vvanilla_graph_clustering.sh "async"