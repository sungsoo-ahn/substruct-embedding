#!/bin/bash
#SBATCH --job-name=gcn_muv
#SBATCH --partition=mbzuai
#SBATCH --ntasks=1
#SBATCH --time=24:00:00
#SBATCH --output=/nfs/projects/mbzuai/peterahn/workspace/substruct-embedding/resource/result/gcn_muv.log
#SBATCH -N 1
#SBATCH -G 1
...
srun \
  ...
  bash ../script/muv/graph_clustering_noaug.sh