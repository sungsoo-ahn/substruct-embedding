import torch
import numpy as np
from model import GNN, GCNConv, GINConv
...
class Model(torch.nn.Module):
    ...
    def compute_logits_and_labels(self, batch, super_batch):
        ...
        pred_features = self.super_encoder(out, super_batch.edge_index, super_batch.edge_attr)
        pred_features = pred_features[super_batch.mask]
