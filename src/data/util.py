...
def graph_data_obj_to_smarts(data_x, data_edge_index, data_edge_attr):
    mol = graph_data_obj_to_mol_simple(data_x, data_edge_index, data_edge_attr)
...
def create_standardized_mol_id(smiles):
    ...
    if check_smiles_validity(smiles):
        ...
        if (
            mol != None
        ):  # to catch weird issue with O=C1O[al]2oc(=O)c3ccc(cn3)c3ccccc3c3cccc(c3)c3ccccc3c3cc(C(F)(F)F)c(cc3o2)-c2ccccc2-c2cccc(c2)-c2ccccc2-c2cccnc21
